...
//                 <label>
//                     Number:
//             <input type="text" onChange={(e) => this.changeValue(e)} name="number" value={this.state.number || ''}
//                     />
//                     Keyword:
//             <input type="text" onChange={(e) => this.changeValue(e)} name="keyword" value={this.state.keyword || ''} />
//                 </label>
