            ...
            <span>
                ...
                <div hidden={this.state.isEmailSend}>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-11 col-sm-4 col-lg-3">
                        ...
                        <div className="col-11 col-sm-4 col-lg-3"><input className={this.state.emailValid ? "" : "error"} id="mail" type="email" placeholder="Ваш E-mail" value={this.state.email} onChange={(e) => { this.onChangeValue(e, { item: "email" }) }} /><br />
