                                ...
                                <span key={index}>
                                    ...
                                    {this.state.collapseItemIddex == item.id ?
                                        <span>
                                            ...
                                            <Analog isAlreadyAdded={this.isAddedToCard.bind(this)} addToCart={this.addToCard.bind(this)} isLoadingAnalog={this.isLoadingAnalog.bind(this)} analogId={+this.state.collapseItemIddex} loading={this.state.loading} />
                                        </span>
                                        : null}
